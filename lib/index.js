...
function lens(getter, setter, path) {
  ...
  return {
    view: function view() {
      var path2 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
      return path2 ? R.clone(R.view(R.lensPath(R.concat(path, path2)), getter())) : R.clone(R.view(focus, getter()));
    },
